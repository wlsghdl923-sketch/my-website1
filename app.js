...
function openCalDocSettings(){
  ...
  document.querySelectorAll('#cdLabelOptGrid .cal-label-opt').forEach(el=>{
...
function calDocSetTab(id){
  const tabs=document.querySelectorAll('#calDocSettingsOverlay .m-stab');
  const tabIds=['display','tags'];
  tabs.forEach((b,i)=>b.classList.toggle('active',tabIds[i]===id));
