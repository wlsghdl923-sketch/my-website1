...
function reHandleImg(e){
  ...
  reader.onload=async ev=>{
    ...
    const imgHtml=`<span class="re-img-wrap" style="display:inline-block;position:relative;width:360px;max-width:100%;vertical-align:top;margin:.5em 0;" contenteditable="false">`+
      ...
      `<span class="re-img-handle" data-dir="se" style="position:absolute;right:-6px;bottom:-6px;width:12px;height:12px;background:#D91F3E;border-radius:50%;cursor:se-resize;z-index:10;border:2px solid #fff;"></span>`+
      `<span class="re-img-handle" data-dir="sw" style="position:absolute;left:-6px;bottom:-6px;width:12px;height:12px;background:#D91F3E;border-radius:50%;cursor:sw-resize;z-index:10;border:2px solid #fff;"></span>`+
      `<span class="re-img-handle" data-dir="ne" style="position:absolute;right:-6px;top:-6px;width:12px;height:12px;background:#D91F3E;border-radius:50%;cursor:ne-resize;z-index:10;border:2px solid #fff;"></span>`+
      `<span class="re-img-handle" data-dir="nw" style="position:absolute;left:-6px;top:-6px;width:12px;height:12px;background:#D91F3E;border-radius:50%;cursor:nw-resize;z-index:10;border:2px solid #fff;"></span>`+
...
function _initImgResize(){
  ...
  editor.addEventListener('mousedown',function(e){
    const handle=e.target.closest ? e.target.closest('.re-img-handle') : null;
    if(!handle)return;
    e.preventDefault();
  ...
  document.addEventListener('mousemove',function(e){
    ...
    let newW=(dir==='se'||dir==='ne')?startW+dx:startW-dx;
