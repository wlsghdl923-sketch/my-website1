...
aside{display:block;background:#F0F4FF;border:1px solid #C7D7FF;border-radius:8px;padding:.8em 1em;margin:.8em 0;color:#1A3A8F;line-height:1.7;}
...
function openRichEditor(docId=''){
  ...
  // 붙여넣기 가로채기 — execCommand 우회하여 aside 등 태그 보존
  if(!editor._pasteHandlerSet){
    ...
    editor.addEventListener('paste',function(e){
      ...
      if(html){
        // execCommand 대신 DOM 직접 조작 → 브라우저 sanitization 우회
