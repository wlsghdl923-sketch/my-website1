...
function _renderDocEmojiGrid(curEmoji){
  ...
  html+=_docCustomImgs.map(ci=>{
    ...
    return'<div class="de-emoji-btn'+(isSel?' sel':'')+'" onclick="pickDocImgEmoji(this,\''+ci.id+'\')" data-imgid="'+ci.id+'"><img src="'+ci.dataUrl+'" style="width:22px;height:22px;object-fit:contain;border-radius:3px;"></div>';
  }).join('');
  grid.innerHTML=html;
}
